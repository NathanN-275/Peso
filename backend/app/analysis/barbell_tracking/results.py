...
def _empty_result(
  ...
  *,
  ...
  coasted_estimated_point_count: int = 0,
  interpolated_point_count: int = 0,
  outlier_bridged_count: int = 0,
  ...
  return {
    ...
    "diagnostics": {
      ...
      "rejected_frame_count": max(
        sampled_frame_count - detected_point_count - interpolated_point_count - coasted_estimated_point_count,
        0,
      ),
